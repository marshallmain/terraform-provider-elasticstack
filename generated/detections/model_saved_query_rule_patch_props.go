...
// checks if the SavedQueryRulePatchProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SavedQueryRulePatchProps{}

// SavedQueryRulePatchProps struct for SavedQueryRulePatchProps
type SavedQueryRulePatchProps struct {
...
func (o SavedQueryRulePatchProps) MarshalJSON() ([]byte, error) {
...
func (o SavedQueryRulePatchProps) ToMap() (map[string]interface{}, error) {
...
type NullableSavedQueryRulePatchProps struct {
	value *SavedQueryRulePatchProps
	isSet bool
}

func (v NullableSavedQueryRulePatchProps) Get() *SavedQueryRulePatchProps {
	return v.value
}

func (v *NullableSavedQueryRulePatchProps) Set(val *SavedQueryRulePatchProps) {
	v.value = val
	v.isSet = true
}

func (v NullableSavedQueryRulePatchProps) IsSet() bool {
	return v.isSet
}

func (v *NullableSavedQueryRulePatchProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSavedQueryRulePatchProps(val *SavedQueryRulePatchProps) *NullableSavedQueryRulePatchProps {
	return &NullableSavedQueryRulePatchProps{value: val, isSet: true}
}

func (v NullableSavedQueryRulePatchProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSavedQueryRulePatchProps) UnmarshalJSON(src []byte) error {
	v.isSet = true

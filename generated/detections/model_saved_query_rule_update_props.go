...
// checks if the SavedQueryRuleUpdateProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SavedQueryRuleUpdateProps{}

// SavedQueryRuleUpdateProps struct for SavedQueryRuleUpdateProps
type SavedQueryRuleUpdateProps struct {
...
func NewSavedQueryRuleUpdateProps(savedId string, type_ string, description string, name string, riskScore int32, severity Severity) *SavedQueryRuleUpdateProps {
	this := SavedQueryRuleUpdateProps{}
...
func (o SavedQueryRuleUpdateProps) MarshalJSON() ([]byte, error) {
...
func (o SavedQueryRuleUpdateProps) ToMap() (map[string]interface{}, error) {
...
type NullableSavedQueryRuleUpdateProps struct {
	value *SavedQueryRuleUpdateProps
	isSet bool
}

func (v NullableSavedQueryRuleUpdateProps) Get() *SavedQueryRuleUpdateProps {
	return v.value
}

func (v *NullableSavedQueryRuleUpdateProps) Set(val *SavedQueryRuleUpdateProps) {
	v.value = val
	v.isSet = true
}

func (v NullableSavedQueryRuleUpdateProps) IsSet() bool {
	return v.isSet
}

func (v *NullableSavedQueryRuleUpdateProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSavedQueryRuleUpdateProps(val *SavedQueryRuleUpdateProps) *NullableSavedQueryRuleUpdateProps {
	return &NullableSavedQueryRuleUpdateProps{value: val, isSet: true}
}

func (v NullableSavedQueryRuleUpdateProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSavedQueryRuleUpdateProps) UnmarshalJSON(src []byte) error {
	v.isSet = true

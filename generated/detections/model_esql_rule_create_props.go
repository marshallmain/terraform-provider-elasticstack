...
// checks if the EsqlRuleCreateProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EsqlRuleCreateProps{}

// EsqlRuleCreateProps struct for EsqlRuleCreateProps
type EsqlRuleCreateProps struct {
...
func (o EsqlRuleCreateProps) MarshalJSON() ([]byte, error) {
...
func (o EsqlRuleCreateProps) ToMap() (map[string]interface{}, error) {
...
type NullableEsqlRuleCreateProps struct {
	value *EsqlRuleCreateProps
	isSet bool
}

func (v NullableEsqlRuleCreateProps) Get() *EsqlRuleCreateProps {
	return v.value
}

func (v *NullableEsqlRuleCreateProps) Set(val *EsqlRuleCreateProps) {
	v.value = val
	v.isSet = true
}

func (v NullableEsqlRuleCreateProps) IsSet() bool {
	return v.isSet
}

func (v *NullableEsqlRuleCreateProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEsqlRuleCreateProps(val *EsqlRuleCreateProps) *NullableEsqlRuleCreateProps {
	return &NullableEsqlRuleCreateProps{value: val, isSet: true}
}

func (v NullableEsqlRuleCreateProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEsqlRuleCreateProps) UnmarshalJSON(src []byte) error {
	v.isSet = true

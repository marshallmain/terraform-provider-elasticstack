...
// checks if the MachineLearningRuleUpdateProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MachineLearningRuleUpdateProps{}

// MachineLearningRuleUpdateProps struct for MachineLearningRuleUpdateProps
type MachineLearningRuleUpdateProps struct {
	// Anomaly threshold
...
func NewMachineLearningRuleUpdateProps(anomalyThreshold int32, machineLearningJobId MachineLearningJobId, type_ string, description string, name string, riskScore int32, severity Severity) *MachineLearningRuleUpdateProps {
	this := MachineLearningRuleUpdateProps{}
...
func (o MachineLearningRuleUpdateProps) MarshalJSON() ([]byte, error) {
...
func (o MachineLearningRuleUpdateProps) ToMap() (map[string]interface{}, error) {
...
type NullableMachineLearningRuleUpdateProps struct {
	value *MachineLearningRuleUpdateProps
	isSet bool
}

func (v NullableMachineLearningRuleUpdateProps) Get() *MachineLearningRuleUpdateProps {
	return v.value
}

func (v *NullableMachineLearningRuleUpdateProps) Set(val *MachineLearningRuleUpdateProps) {
	v.value = val
	v.isSet = true
}

func (v NullableMachineLearningRuleUpdateProps) IsSet() bool {
	return v.isSet
}

func (v *NullableMachineLearningRuleUpdateProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMachineLearningRuleUpdateProps(val *MachineLearningRuleUpdateProps) *NullableMachineLearningRuleUpdateProps {
	return &NullableMachineLearningRuleUpdateProps{value: val, isSet: true}
}

func (v NullableMachineLearningRuleUpdateProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMachineLearningRuleUpdateProps) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the EqlRuleCreateProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EqlRuleCreateProps{}

// EqlRuleCreateProps struct for EqlRuleCreateProps
type EqlRuleCreateProps struct {
...
func (o EqlRuleCreateProps) MarshalJSON() ([]byte, error) {
...
func (o EqlRuleCreateProps) ToMap() (map[string]interface{}, error) {
...
type NullableEqlRuleCreateProps struct {
	value *EqlRuleCreateProps
	isSet bool
}

func (v NullableEqlRuleCreateProps) Get() *EqlRuleCreateProps {
	return v.value
}

func (v *NullableEqlRuleCreateProps) Set(val *EqlRuleCreateProps) {
	v.value = val
	v.isSet = true
}

func (v NullableEqlRuleCreateProps) IsSet() bool {
	return v.isSet
}

func (v *NullableEqlRuleCreateProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEqlRuleCreateProps(val *EqlRuleCreateProps) *NullableEqlRuleCreateProps {
	return &NullableEqlRuleCreateProps{value: val, isSet: true}
}

func (v NullableEqlRuleCreateProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEqlRuleCreateProps) UnmarshalJSON(src []byte) error {
	v.isSet = true

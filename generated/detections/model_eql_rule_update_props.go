...
// checks if the EqlRuleUpdateProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EqlRuleUpdateProps{}

// EqlRuleUpdateProps struct for EqlRuleUpdateProps
type EqlRuleUpdateProps struct {
...
func (o EqlRuleUpdateProps) MarshalJSON() ([]byte, error) {
...
func (o EqlRuleUpdateProps) ToMap() (map[string]interface{}, error) {
...
type NullableEqlRuleUpdateProps struct {
	value *EqlRuleUpdateProps
	isSet bool
}

func (v NullableEqlRuleUpdateProps) Get() *EqlRuleUpdateProps {
	return v.value
}

func (v *NullableEqlRuleUpdateProps) Set(val *EqlRuleUpdateProps) {
	v.value = val
	v.isSet = true
}

func (v NullableEqlRuleUpdateProps) IsSet() bool {
	return v.isSet
}

func (v *NullableEqlRuleUpdateProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEqlRuleUpdateProps(val *EqlRuleUpdateProps) *NullableEqlRuleUpdateProps {
	return &NullableEqlRuleUpdateProps{value: val, isSet: true}
}

func (v NullableEqlRuleUpdateProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEqlRuleUpdateProps) UnmarshalJSON(src []byte) error {
	v.isSet = true

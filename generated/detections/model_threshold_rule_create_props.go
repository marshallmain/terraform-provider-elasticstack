...
// checks if the ThresholdRuleCreateProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThresholdRuleCreateProps{}

// ThresholdRuleCreateProps struct for ThresholdRuleCreateProps
type ThresholdRuleCreateProps struct {
...
func (o ThresholdRuleCreateProps) MarshalJSON() ([]byte, error) {
...
func (o ThresholdRuleCreateProps) ToMap() (map[string]interface{}, error) {
...
type NullableThresholdRuleCreateProps struct {
	value *ThresholdRuleCreateProps
	isSet bool
}

func (v NullableThresholdRuleCreateProps) Get() *ThresholdRuleCreateProps {
	return v.value
}

func (v *NullableThresholdRuleCreateProps) Set(val *ThresholdRuleCreateProps) {
	v.value = val
	v.isSet = true
}

func (v NullableThresholdRuleCreateProps) IsSet() bool {
	return v.isSet
}

func (v *NullableThresholdRuleCreateProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThresholdRuleCreateProps(val *ThresholdRuleCreateProps) *NullableThresholdRuleCreateProps {
	return &NullableThresholdRuleCreateProps{value: val, isSet: true}
}

func (v NullableThresholdRuleCreateProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThresholdRuleCreateProps) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the NewTermsRuleOptionalFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewTermsRuleOptionalFields{}

// NewTermsRuleOptionalFields struct for NewTermsRuleOptionalFields
type NewTermsRuleOptionalFields struct {
...
func NewNewTermsRuleOptionalFields() *NewTermsRuleOptionalFields {
	this := NewTermsRuleOptionalFields{}
	return &this
}
...
func (o NewTermsRuleOptionalFields) MarshalJSON() ([]byte, error) {
...
func (o NewTermsRuleOptionalFields) ToMap() (map[string]interface{}, error) {
...
type NullableNewTermsRuleOptionalFields struct {
	value *NewTermsRuleOptionalFields
	isSet bool
}

func (v NullableNewTermsRuleOptionalFields) Get() *NewTermsRuleOptionalFields {
	return v.value
}

func (v *NullableNewTermsRuleOptionalFields) Set(val *NewTermsRuleOptionalFields) {
	v.value = val
	v.isSet = true
}

func (v NullableNewTermsRuleOptionalFields) IsSet() bool {
	return v.isSet
}

func (v *NullableNewTermsRuleOptionalFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewTermsRuleOptionalFields(val *NewTermsRuleOptionalFields) *NullableNewTermsRuleOptionalFields {
	return &NullableNewTermsRuleOptionalFields{value: val, isSet: true}
}

func (v NullableNewTermsRuleOptionalFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewTermsRuleOptionalFields) UnmarshalJSON(src []byte) error {
	v.isSet = true

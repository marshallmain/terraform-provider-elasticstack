...
// checks if the QueryRulePatchProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryRulePatchProps{}

// QueryRulePatchProps struct for QueryRulePatchProps
type QueryRulePatchProps struct {
	// Rule type
...
func (o QueryRulePatchProps) MarshalJSON() ([]byte, error) {
...
func (o QueryRulePatchProps) ToMap() (map[string]interface{}, error) {
...
type NullableQueryRulePatchProps struct {
	value *QueryRulePatchProps
	isSet bool
}

func (v NullableQueryRulePatchProps) Get() *QueryRulePatchProps {
	return v.value
}

func (v *NullableQueryRulePatchProps) Set(val *QueryRulePatchProps) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryRulePatchProps) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryRulePatchProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryRulePatchProps(val *QueryRulePatchProps) *NullableQueryRulePatchProps {
	return &NullableQueryRulePatchProps{value: val, isSet: true}
}

func (v NullableQueryRulePatchProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryRulePatchProps) UnmarshalJSON(src []byte) error {
	v.isSet = true

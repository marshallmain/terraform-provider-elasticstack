...
// checks if the QueryRuleCreateProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryRuleCreateProps{}

// QueryRuleCreateProps struct for QueryRuleCreateProps
type QueryRuleCreateProps struct {
	// Rule type
...
func (o QueryRuleCreateProps) MarshalJSON() ([]byte, error) {
...
func (o QueryRuleCreateProps) ToMap() (map[string]interface{}, error) {
...
type NullableQueryRuleCreateProps struct {
	value *QueryRuleCreateProps
	isSet bool
}

func (v NullableQueryRuleCreateProps) Get() *QueryRuleCreateProps {
	return v.value
}

func (v *NullableQueryRuleCreateProps) Set(val *QueryRuleCreateProps) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryRuleCreateProps) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryRuleCreateProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryRuleCreateProps(val *QueryRuleCreateProps) *NullableQueryRuleCreateProps {
	return &NullableQueryRuleCreateProps{value: val, isSet: true}
}

func (v NullableQueryRuleCreateProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryRuleCreateProps) UnmarshalJSON(src []byte) error {
	v.isSet = true

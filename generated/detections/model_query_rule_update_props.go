...
// checks if the QueryRuleUpdateProps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryRuleUpdateProps{}

// QueryRuleUpdateProps struct for QueryRuleUpdateProps
type QueryRuleUpdateProps struct {
	// Rule type
...
func (o QueryRuleUpdateProps) MarshalJSON() ([]byte, error) {
...
func (o QueryRuleUpdateProps) ToMap() (map[string]interface{}, error) {
...
type NullableQueryRuleUpdateProps struct {
	value *QueryRuleUpdateProps
	isSet bool
}

func (v NullableQueryRuleUpdateProps) Get() *QueryRuleUpdateProps {
	return v.value
}

func (v *NullableQueryRuleUpdateProps) Set(val *QueryRuleUpdateProps) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryRuleUpdateProps) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryRuleUpdateProps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryRuleUpdateProps(val *QueryRuleUpdateProps) *NullableQueryRuleUpdateProps {
	return &NullableQueryRuleUpdateProps{value: val, isSet: true}
}

func (v NullableQueryRuleUpdateProps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryRuleUpdateProps) UnmarshalJSON(src []byte) error {
	v.isSet = true

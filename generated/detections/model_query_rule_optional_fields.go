...
// checks if the QueryRuleOptionalFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryRuleOptionalFields{}

// QueryRuleOptionalFields struct for QueryRuleOptionalFields
type QueryRuleOptionalFields struct {
...
func (o QueryRuleOptionalFields) MarshalJSON() ([]byte, error) {
...
func (o QueryRuleOptionalFields) ToMap() (map[string]interface{}, error) {
...
type NullableQueryRuleOptionalFields struct {
	value *QueryRuleOptionalFields
	isSet bool
}

func (v NullableQueryRuleOptionalFields) Get() *QueryRuleOptionalFields {
	return v.value
}

func (v *NullableQueryRuleOptionalFields) Set(val *QueryRuleOptionalFields) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryRuleOptionalFields) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryRuleOptionalFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryRuleOptionalFields(val *QueryRuleOptionalFields) *NullableQueryRuleOptionalFields {
	return &NullableQueryRuleOptionalFields{value: val, isSet: true}
}

func (v NullableQueryRuleOptionalFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryRuleOptionalFields) UnmarshalJSON(src []byte) error {
	v.isSet = true

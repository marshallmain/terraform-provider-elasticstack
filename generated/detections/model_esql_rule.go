...
// checks if the EsqlRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EsqlRule{}

// EsqlRule struct for EsqlRule
type EsqlRule struct {
...
func (o EsqlRule) MarshalJSON() ([]byte, error) {
...
func (o EsqlRule) ToMap() (map[string]interface{}, error) {
...
type NullableEsqlRule struct {
	value *EsqlRule
	isSet bool
}

func (v NullableEsqlRule) Get() *EsqlRule {
	return v.value
}

func (v *NullableEsqlRule) Set(val *EsqlRule) {
	v.value = val
	v.isSet = true
}

func (v NullableEsqlRule) IsSet() bool {
	return v.isSet
}

func (v *NullableEsqlRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEsqlRule(val *EsqlRule) *NullableEsqlRule {
	return &NullableEsqlRule{value: val, isSet: true}
}

func (v NullableEsqlRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEsqlRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
